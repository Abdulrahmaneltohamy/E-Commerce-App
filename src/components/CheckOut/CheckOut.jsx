...
export default function checkOut() {
  let { cart, headerToken , setCart , getCart} = useContext(CartContext)
  // const [isOnline, setIsOnline] = useState(false)
  let navigate = useNavigate()

  async function checkOutHandle(shippingAddress) {
    try {
  ...
  return (
    <>
      <div className="container w-1/2 md:w-1/3 mx-auto my-8 px-10 py-10 border-gray-300 border-2 shadow-xl rounded-3xl">
